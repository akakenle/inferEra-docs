...
**例の図は以下の通りです。**
![プラグインのインストール](../../public/en/DifyInstallPlugin.png)  
...
![設定](../../public/en/DifySettings1.png)  
...
![モデル設定完了](../../public/en/DifyModelsSetting.png)  
...
![カスタムモデルの追加](../../public/en/DifyAddModel.png)  
