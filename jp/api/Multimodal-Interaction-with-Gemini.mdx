...
"modalities": ["text","image"]
{
    ...
    "messages": [
      {
        "role": "user",
        "content": "山水画を生成し、それを説明する詩を書いてください"
      }
    ],
    ...
    "messages": [
      {
        ...
        "content": [
          {
            "type":"text",
            "text":"画像を簡潔で魅力的な段落で説明し、子供のクレヨンスタイルで色を塗ってください"
          },
          {
            "type": "image_url",
            "image_url": {
    ...
    messages=[
        {
            ...
            "content": [
                {
                    "type": "text",
                    "text": "海にかわいい人魚を生成し、太い輪郭、ちび漫画、子供の塗り絵のスタイル、白黒、HD",
                }
            ],
        },
    ],
...
![画像](/media/en/gemini-s-flash-exp-usage-shot.png)
...
![画像](/media/en/gemini-s-flash-exp-usage-shot-2.png)
...
<video controls className="w-full aspect-video rounded-2xl" src="/media/en/veo-3-output.mp4" />
...
operation = client.models.generate_videos(
    ...
    prompt="日差しの中で眠る三毛猫の子猫のパンニングワイドショット",
