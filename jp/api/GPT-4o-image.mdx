...
<Card title="真珠の耳飾りの少女" img="/media/en/Girl-with-a-Pearl-Earring.PNG">
  1. 名画を再解釈し、レイアウトと透かしを直接出力。
</Card>

<Card title="ピクサーカートゥーン" img="/media/en/pixar.png">
  1. ピクサー3Dカートゥーンスタイル、安定性抜群。
</Card>

<Card title="3D" img="/media/en/ghibli.png">
  1. 最も人気のあるジブリ
</Card>
