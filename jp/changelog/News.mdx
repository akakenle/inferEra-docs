...
<Update label="8月10日">
- 開発者が画像生成サービスを簡単に統合できるように、[Aihubmix 画像生成 MCP](/jp/clients/AHM-mcp) をリリース
</Update>

<Update label="8月1日">
  - AiHubMixプラットフォーム上の任意の大規模モデルを [Claude Code](/jp/api/CC-any) 内で利用可能
</Update>

<Update label="7月29日">
  - [AI SDK](/jp/clients/AISDK) のサポートを追加し、1つのキーで多数のモデルにアクセスできます。
</Update>

<Update label="7月23日">
  - [Qwen Code](/jp/api/Qwen-code) のサポートを追加し、Aihubmix プラットフォーム上のすべての大規模言語モデルを活用しています。
</Update>

<Update label="7月4日">
  - [llms.txt](/en/llms) を追加しました。LLM アシスタントが主要なモデルのエコシステムをすばやくナビゲートできるようになります。
</Update>
...
<Update label="7月20日">
  ...
  - 詳細は [Open AI公式価格](https://openai.com/api/pricing/) をご覧ください。  
    ...
    ![画像](/media/en/4ominijiage.png)  

    ![画像](/media/en/4ojiage.png)
</Update>
