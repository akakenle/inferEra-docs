...
This is the canonical version of [`llms.txt`](https://assets.aihubmix.com/docs/llms.txt), self-hosted and stripped of Mintlify’s extra multilingual content. The block below reflects it exactly.
