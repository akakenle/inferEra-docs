...
- For the Claude model, we support the native `v1/messages` interface. Details are available here: [How to Use the Native Claude API](/en/api/Claude-Native).
