...
![Image](../../public/cn/zotero1.png)  
Enter
```
/api https://aihubmix.com
```
and press Enter  
![Image](../../public/cn/zotero2.png) 
![Image](../../public/cn/zotero3.png)  
Enter
```
/secretKey + your API key (generated from the Key, remember to include sk-)
```
![Image](../../public/cn/zotero4.png) 
![Image](../../public/cn/zotero8.png)  
Switch model command  
```
/model gpt-3.5-turbo-0125 
```
![Image](../../public/cn/zotero6.png)  
After selecting the model you want to use, you can start using it.  
![Image](../../public/cn/zotero7.png)  
