...
![Image](/media/en/zotero1.png)  
Enter
```
/api https://aihubmix.com
```
and press Enter  
![Image](/media/en/zotero2.png) 
![Image](/media/en/zotero3.png)  
Enter
```
/secretKey + your API key (generated from the Key, remember to include sk-)
```
![Image](/media/en/zotero4.png) 
![Image](/media/en/zotero8.png)  
Switch model command  
```
/model gpt-3.5-turbo-0125 
```
![Image](/media/en/zotero6.png)  
After selecting the model you want to use, you can start using it.  
![Image](/media/en/zotero7.png)  
