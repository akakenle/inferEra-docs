...
<Tip>
  ...
  4. Reasoning models (o series / gpt-5 series) have deprecated max_tokens. Please use `max_completion_tokens` for completions or `max_output_tokens` for responses to explicitly set the output token limit.
</Tip>
