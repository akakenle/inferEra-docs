...
- Reasoning: Reasoning
- Verbose: Output length, `gpt-5` supports 3 levels
- Functions: Functions
...
response = client.responses.create(
    ...
    reasoning={
        "effort": "minimal" # Reasoning depth – Controls how many reasoning tokens the model generates before producing a response. Value can be "minimal", "medium", or "high". Default is "medium".
    },
    text={
