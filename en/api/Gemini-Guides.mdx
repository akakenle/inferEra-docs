...
Our Gemini integration supports automatic routing through both AI Studio and VertexAI. By adding the `EDIARESOLUTION_MEDIUM` parameter, you can adjust the image resolution, which significantly reduces input costs and minimizes the risk of errors with large images.
