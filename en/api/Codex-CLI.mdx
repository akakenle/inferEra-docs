---
title: "OpenAI Codex CLI Integration"
...
Before using, please run the following command to install or update:
...
> Skip manual environment variable configuration – use the graphical tool for quick setup: [Configuration via CC-Switch](https://docs.aihubmix.com/en/api/Codex-CLI#configuration-via-cc-switch).
...
![Image](../../public/en/cc-codex-1.png)

2. From the preset list, select "AiHubMix."

![Image](../../public/en/cc-codex-2.png)

3. Enter your API key in the "API Key" field, then click "Add" to save the settings.

![Image](../../public/en/cc-codex-3.png)

4. Return to the home page, select "AiHubMix" from the vendor list, and click "Start" to begin using it.

![Image](../../public/en/cc-codex-4.png)

## Advanced Configuration

<Tip>
  - The default model is `codex-mini-latest` - a fine-tuned version of `o4-mini` specifically for use in Codex CLI, which can be modified in `~/.codex/config.json`
