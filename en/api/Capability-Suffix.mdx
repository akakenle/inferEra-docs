...
icon: "badge-percent"
description: "To reduce the cost of multi-model capability usage and interface adaptation, the platform provides advanced capabilities of certain models through a suffix configuration, allowing users to access them directly under a unified OpenAI / Chat interface."
---
