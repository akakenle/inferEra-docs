...
2. Tool call: Does not support OpenAI compatible format, you need to run the command to install the dependency `pip install -U qwen-agent mcp`. For more details, please refer to [Ali official documentation](https://huggingface.co/Qwen/Qwen3-235B-A22B)
