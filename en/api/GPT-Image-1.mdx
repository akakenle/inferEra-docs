...
Azure OpenAI's `gpt-image-1` image generation API offers both text-to-image generation and image-to-image editing with text guidance capabilities.  
...
client = OpenAI(
    api_key="AIHUBMIX_API_KEY", # Replace with your API Key "sk-***" from your dashboard
