...
<Tip>
  Key points: Only need to add the forwarding `base_url` and AiHubMix platform [API key](https://aihubmix.com/token) inside the client. Model IDs can be obtained by clicking the "Copy Button" on [model marketplace cards](https://aihubmix.com/models).
</Tip>
