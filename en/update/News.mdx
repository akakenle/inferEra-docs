...
<Update label="Sep 22, 2025">
  - Added [Qwen series, Douban seedream4 and Baidu series image models](/en/api/Image-Gen)
</Update>

<Update label="Aug 10, 2025">
  - Launched [Aihubmix Image Generation MCP](/en/clients/AHM-mcp) to make it easier for developers to integrate image generation services
</Update>

<Update label="Aug 1, 2025">
  - Use any large model on the AiHubMix platform within [Claude Code](/en/api/CC-any)
</Update>

<Update label="July 29, 2025">
  - Added [AI SDK](/en/clients/AISDK) support, enabling access to numerous models with a single key.
</Update>

<Update label="July 26, 2025">
  - Added support for [Flux API](/en/api/Image-Gen)，enabling instant high-quality image generation.
</Update>

<Update label="July 23, 2025">
  - Added support for [Qwen Code](/en/api/Qwen-code), leveraging all large language models on the Aihubmix platform.
</Update>

<Update label="July 4, 2025">
  - Added [llms.txt](/en/llms) support — a single link to help your LLM assistant quickly navigate the entire model ecosystem.
</Update>

<Update label="June 29, 2025">
  - Added [Gemini Cli](/en/api/Gemini-Cli) documentation, supporting Gemini model usage in your terminal.
  - The OpenAI Responses API now supports Code Interpreter and Remote MCP calls.
</Update>

<Update label="June 26, 2025">
  - Added [Universal Image Generation API](/en/api/Image-Gen), supporting multiple mainstream models including OpenAI, Ideogram, Stability, and Google Imagen.
</Update>

<Update label="June 23, 2025">
  - Introduced [APP-Code](/en/api/App-code), providing 10% discounts for all models for developers.
</Update>

<Update label="June 18, 2025">
  - Added [HTTP Status Codes](/en/FAQs/HTTP-Codes) documentation to help users better understand error information.
</Update>

<Update label="June 15, 2025">
  - Added Veo 3.0 reverse access method, with a total cost of just \$0.41 per video generation.
</Update>

<Update label="June 13, 2025">
  - Added support for [Veo3.0](https://aihubmix.com/models?model=veo-3.0-generate-preview) generation, enabling more diverse creative formats.
</Update>

<Update label="June 12, 2025">
  - Integrated Claude, enabling stable use in China.
</Update>

<Update label="June 9, 2025">
  - Supports displaying OpenAI Reasoning summaries, applicable to the responses API.
</Update>

<Update label="June 5, 2025">
  - Added Gemini implicit caching feature, supporting automatic hit and hit feedback. Developers can determine hit status through usage_metadata. Cost savings are not guaranteed, and actual effects depend on request structure and usage scenarios.
</Update>

<Update label="May 31, 2025">
  **Comprehensive Claude 4 New Features Support**

  - ⏳ **New Cache Duration**: Claude 1-hour cache duration<sup>beta</sup> support.
  - 🎉 **New Text Editor Tool**: Claude 4 models support the new `text_editor_20250429` tool type and `str_replace_based_edit_tool` tool name
  - 🚫 **Refusal Stop Reason**: Introduced new `refusal` stop reason for content the model declines to generate for safety reasons
  - 🧠 **Extended Thinking**: Claude 4 models return a summary of the full thinking process, providing complete intelligence benefits of extended thinking
  - 🔄 **Interleaved Thinking**: Support for interleaving tool use with extended thinking, enabling more natural conversation experiences (Beta feature)
  - ⚠️ **Deprecated Features**:
    - Claude 4 text editor tool no longer supports `undo_edit` command
    - Removed `token-efficient-tools-2025-02-19` support (Claude 3.7 only)
    - Removed `output-128k-2025-02-19` support (Claude 3.7 only)
  - 📚 Updated comprehensive migration guide and code examples to help users smoothly migrate from Claude 3.7 to Claude 4
</Update>

<Update label="May 22, 2025">
  - Added support for Dify plugin, enabling seamless integration of Aihubmix models in Dify.
</Update>

<Update label="May 17, 2025">
  - The codex-mini-latest model, designed specifically for programming tasks, is now supported and can be accessed via the Responses API endpoint or the Codex CLI.
  - Support Google Imagen 3.0 for image generation and Veo 2.0 for video creation, enriching your creative formats.
  - gemini-2.0-flash-exp has been upgraded to gemini-2.0-flash-preview-image-generation
</Update>

<Update label="May 9, 2025">
  Added [Ideogram AI V3](/en/api/IdeogramAI) interface, the most advanced image generation model.
</Update>

<Update label="May 6, 2025">
  Added [AiHubMix CLI](/en/api/Cli), supporting command-line management of keys, account information, and available model lists.
</Update>

<Update label="April 26, 2025">
  1. The long-awaited OpenAI image generation interface is officially launched, supporting text-to-image generation and image-to-image editing.
  2. Supports native invocation for Gemini models
</Update>

<Update label="April 24, 2025">
  Integrated with 3 core APIs from Jina AI, empowering you to effortlessly build powerful intelligent agents. The three APIs are: Vector Embeddings, Rerank, and Deep Search.
</Update>

<Update label="April 22, 2025">
  GPT 4o Image Reverse Interface Early Access.
</Update>

<Update label="April 20, 2025">
  OpenAI Responses API is supported, offering more comprehensive tool integration.
</Update>

<Update label="April 17, 2025">
  Added OpenAI CodeX Cli support, Tell Codex CLI what to build, fix, or explain, then watch it [bring your ideas to life](/en/api/Codex-CLI).
</Update>

<Update label="April 12, 2025">
  Added `:surfing` to the model id to [<sup>enable search functionality for any model Beta</sup>](/en/api/LLM-Search)
</Update>
...
<Update label="July 20, 2024">
  ...
  - More details at [**OpenAI Official Pricing**](https://openai.com/api/pricing/)
    ...
    ![Image](/media/en/4ominijiage.png)

    ![Image](/media/en/4ojiage.png)
</Update>
