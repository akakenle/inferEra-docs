...
**示例图如下：**
![安装插件](/media/cn/DifyInstallPlugin.png)  
...
![模型设置好](/media/cn/DifyModelsSetting.png)  
...
![新增自定义模型](/media/cn/DifyAddModel.png)  
