...
description: " 在 AIHubMix 中使用 Claude Code，Claude Code 是一款面向开发者的 AI 编程助手，可以直接在代码库中帮助完成理解代码、修改文件、排查问题、运行测试和推进开发任务。它不只是回答编程问题，更像一个能够进入实际工作流、协助完成编码与调试的智能搭档。"
icon: "guitar"
---
...
<Frame>
  ![I Shot 2026 03 25 11 44 03](/images/iShot_2026-03-25_11.44.03.jpg)
</Frame>

2. 按下 `Ctrl + Shift + P` (或 `Cmd + Shift + P`)，输入 `Settings` 打开设置。

<Frame>
  ![I Shot 2026 03 25 11 47 48](/images/iShot_2026-03-25_11.47.48.jpg)
</Frame>

3. 搜索 `Claude Code` ，找到 `Claude Code: Environment Variable` → `Edit in settings.json` 。

<Frame>
  ![I Shot 2026 03 25 11 49 37](/images/iShot_2026-03-25_11.49.37.jpg)
</Frame>

4. 在 `claudeCode.environmentVariables` 中填入 AIHubMix 相关信息。

<Frame>
  ![I Shot 2026 03 25 11 53 07](/images/iShot_2026-03-25_11.53.07.jpg)
</Frame>
