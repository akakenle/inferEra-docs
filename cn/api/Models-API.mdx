...
<Request
  ...
  auth="none"
  params={[
    { name: "type", type: "string", example: "llm", description: "模型类型（llm、image_generation、video、tts、stt、embedding、rerank）" },
    { name: "modalities", type: "string", example: "text,image", description: "输入模态筛选（text、image、audio、video、pdf）" },
    { name: "model", type: "string", example: "gpt-5", description: "模型名称模糊搜索" },
    { name: "features", type: "string", example: "thinking,function_calling", description: "功能特性（thinking、tools、structured_outputs等）" },
    { name: "sort_by", type: "string", example: "context_length", description: "排序字段（model_ratio/context_length/coding/order）" },
    { name: "sort_order", type: "string", example: "desc", description: "排序方向（asc/desc）" }
  ]}
/>
