...
response = client.responses.create(
    ...
    reasoning={
        "effort": "minimal" # 推理深度 - Controls how many reasoning tokens the model generates before producing a response. value can be "minimal", "medium", "high", default is "medium"
    },
    text={
