...
> 不想手动配置环境变量？可使用图形化工具快速设置：[通过 CC-Switch 可视化配置](https://docs.aihubmix.com/cn/api/Codex-CLI#%E9%80%9A%E8%BF%87-cc-switch-%E9%85%8D%E7%BD%AE)。
...
![install](../../public/cn/cc-codex-1.png)

2. 在预设列表中选择「AiHubMix」。

![install](../../public/cn/cc-codex-2.png)

3. 在「API Key」栏中填写你的密钥并点击「添加」保存设置。

![install](../../public/cn/cc-codex-3.png)

4. 返回首页，在供应商列表中选择「AiHubMix」，点击「启动」即可使用。

![install](../../public/cn/cc-codex-4.png)
