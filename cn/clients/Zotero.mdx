...
![图片](/media/cn/zotero9.png)
按照如图所示配置 Base API，并输入[API key](https://aihubmix.com/token)

或者使用以下命令设置

首选使用「ctrl＋/」打开使用窗口  
![图片](/media/cn/zotero1.png)  
输入
```
/api https://aihubmix.com
```
并回车  
![图片](/media/cn/zotero2.png) 
![图片](/media/cn/zotero3.png)  
输入
```
/secretKey ＋ 密钥 sk-***
```
![图片](/media/cn/zotero4.png) 
![图片](/media/cn/zotero8.png)  
切换模型命令  
```
/model gpt-3.5-turbo-0125 
```
![图片](/media/cn/zotero6.png)  
选择自己要用的模型之后就可以使用了。  
![图片](/media/cn/zotero7.png)  
