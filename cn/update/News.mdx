...
<Update label="03 月 29 日">
  新功能:为了帮助用户更高效地分析模型调用效果、定位问题并优化性能，我们对调用记录进行了增强，新增多项关键指标字段。

  **本次更新解决的问题**

  - 无法判断请求慢在哪里 → 新增「首 Token 延时」与「E2E 延时」，清晰区分响应启动速度与整体耗时
  - 无法评估模型生成效率 → 新增「吞吐量」，直观衡量模型输出速度
  - 缺少缓存效果数据 → 新增「缓存 Tokens」，帮助分析缓存命中与成本优化空间
  - 多服务商难以对比 → 新增「服务商」字段，支持不同模型/供应商效果对比
  - 问题排查困难 → 新增「tid」与「状态」，可帮助快速定位异常请求
</Update>

<Update label="03 月 23 日">
...
<Update label="7 月 20 日">
  ...
  - 详情可见 Open AI 官方价格 <img src="/media/cn/4ominijiage.png" alt="图片" /> <img src="/media/cn/4ojiage.png" alt="图片" />
</Update>
