...
- 推出 [Aihubmix 圖片生成 MCP](/zh-Hant/clients/AHM-mcp)，方便開發者接入圖片生成服務
</Update>

<Update label="8 月 1 日">
  - 可在 [Claude Code](/zh-Hant/api/CC-any) 中使用 AiHubMix 平台上的任何大型模型
</Update>

<Update label="7 月 29 日">
  - 新增 [AI SDK](/zh-Hant/clients/AISDK) 支援，一個 KEY 接入海量模型。
</Update>

<Update label="7 月 23 日">
  - 新增 [Qwen Code](/zh-Hant/api/Qwen-code) 支持，利用 Aihubmix 平台的所有大语言模型来提供支持。
</Update>

<Update label="7 月 4 日">
  - 新增 [llms.txt](/en/llms) 支援，一個連結讓你的 LLM 助手快速掌握主流模型生態。
</Update>
