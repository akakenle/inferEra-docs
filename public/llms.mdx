...
This is the canonical version of  [`llms.txt`](https://yinchao.oss-cn-hangzhou.aliyuncs.com/docs/llms.txt), self-hosted and stripped of Mintlify’s extra multilingual content. The block below reflects it exactly.
