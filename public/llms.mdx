...
This page presents a formatted version of [`llms.txt`](https://yinchao.oss-cn-hangzhou.aliyuncs.com/docs/llms.txt), which is self-hosted and free from auto-generated multilingual clutter. Use this version for a clean, standardized reference.
...
- **Flexibility**: No subscription or membership plans—pay-as-you-go simplicity for any AI capability
